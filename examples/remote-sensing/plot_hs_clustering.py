"""
====================================================================
Remote sensing: Clustering on hyperspectral with Riemannian geometry
====================================================================

This example compares clustering pipelines based on covariance matrices for
hyperspectral data custering.
"""
...
from helpers.processing_helpers import (
    SlidingWindowVectorize, LabelsToImage, PCAImage, RemoveMeanImage
)
from helpers.datasets_helpers import (
        download_salinas, read_salinas,
)
