...
for delta in deltas_array:
    ...
    scores_array.append(cross_val_score(clf, X, y, cv=skf, scoring="roc_auc").mean())
...
ax2.plot(
    deltas_array, class_dis_array, lw=3.0, color="g", label="Class Distinctiveness"
)
...
ax1.set_title(
    "Classification score and class distinctiveness value\n"
