...
class TLRotate(TransformerMixin, BaseEstimator):
    ...
    tol_step : float, default=1e-9
        For inputs in manifold. Stopping criterion based on the norm of the descent direction.
    maxiter : int, default=10_000
        For inputs in manifold. Maximum number of iterations in the optimization procedure.
