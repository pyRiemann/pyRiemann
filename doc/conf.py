...
man_pages = [(master_doc, 'pyriemann', u'pyRiemann Documentation', [author],
              1)]
...
texinfo_documents = [
    (master_doc, 'pyriemann', u'pyRiemann Documentation', author, 'pyriemann',
